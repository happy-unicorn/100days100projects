...
const Component = ({ field, form, ...props }) => {
    ...
    return (
        <Wrapper>
            <InputWrapper isError={isError} {...props}>
                {isPlaceholder && <Placeholder {...props}>{props.placeholder}</Placeholder>}
                <InputInner isError={isError} {...props}>
                    <Input
                ...
                <Error isError={isError} {...props}>{form.errors[field.name]}</Error>
            </InputWrapper>
        </Wrapper>
    );
};
